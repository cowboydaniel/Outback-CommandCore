...
def create_device_info_tab(ui):
    ...
    btn_layout.addWidget(QtWidgets.QLabel("Connect Device"))
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("WiFi ADB"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Refresh"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Remove Offline"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
...
def create_device_actions(ui, parent_layout):
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Screenshot"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Backup"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Files"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Install APK"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("App Manager"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
    ...
    btn_layout.addWidget(icon_widget)
    btn_layout.addWidget(QtWidgets.QLabel("Logcat"))
    btn_layout.setSpacing(8)
    btn_layout.setContentsMargins(12, 0, 12, 0)
