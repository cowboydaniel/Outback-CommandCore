...
class ForensicsMixin:
    ...
    Andriller is driven natively (see ``AndrillerNativeMixin`` in
    ``andriller_native.py``) rather than launched as a separate GUI process,
    so its `run_andriller` lives there instead of here.
    """
